...
var SwipeRecognizer = function (_AttrRecognizer) {
  ...
  createClass(SwipeRecognizer, [{
    ...
    value: function attrTest(input) {
      ...
      return get(SwipeRecognizer.prototype.__proto__ || Object.getPrototypeOf(SwipeRecognizer.prototype), 'attrTest', this).call(this, input)
      && direction & input.offsetDirection
      && input.distance > this.options.threshold
      && input.maxPointers === this.options.pointers
      && abs(velocity) > this.options.velocity
      /*mhs && input.eventType & INPUT_END*/;
    }
  }, {
    key: 'emit',
    value: function emit(input) {
